...
<html>
  ...
  <body class="">
    <span class="preheader">Credenciales de acceso.</span>
      ...
      <tr>
        ...
        <td class="container">
		  ...
		  <div class="content">
		  		...
		  		<p class="apple-link">Su {{ $update?'Actualización':'Registro'}} se ha realizado con éxito</p>

				<p class="apple-link">Su usuario es: <strong>{{ $infoUser['email']}}</strong></p>
				<p class="apple-link">Su Contraseña de acceso es: <strong>{{ $password}}</strong></p>
